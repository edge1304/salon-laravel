...
@section('title')
    ...
    <title>Phiếu xuất bán | Tạo mới</title>
@endsection
@section('css')
        ...
        <div class="content">
            <div class="row head-find" >
                <div class="col-6 col-sm-6 col-md-3 col-lg-3  col-xl-3 div-find-customer">
                    ...
                    <input class="form-control" id="input_name_customer" oninput="find_customer(callback_find_customer)" placeholder="Nhập tên hoặc sđt khách hàng" type="text">
                ...
                <div id="div-info-payment">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                                <input type="text" disabled class="form-control integer" id="total_money" oninput="changeMoney()" value="0">
                            </td>
                            <td><div>Khách thanh toán:</div></td>
                            <td>
                                <input type="text" class="form-control integer" id="total_receive" oninput="changeMoney()" value="0">
                            </td>
                            <td><div>Đã trả lại:</div></td>
                            <td>
                                <input type="text" class="form-control integer" id="total_return" oninput="changeMoney()" value="0">
                            </td>
                        </tr>
                        <tr>
                            <td><div>Ghi chú</div></td>
                            <td>
                                <input id="note" type="text" class="form-control" placeholder="Nhập ghi chú">
                            </td>
                            <td><div>Hình thức thanh toán</div></td>
                            <td>
                                <select id="selectFundnook">
                                    {!! $htmlFundbook !!}
                                </select>
                            </td>
                            <td></td>
...
@section('script')
    ...
    @endif
    <script src="/js/formexport/add.js"></script>
@endsection
